...
import ConnectionCard from "@/components/cards/connections/connection-card";
import {
  onDiscordConnect,
  onNotionConnect,
  onSlackConnect,
} from "@/lib/actions/connections.actions";
import { getUserByClerkId } from "@/lib/actions/settings.actions";
...
const Connections = async (props: Props) => {
  ...
  const onUserConnections = async () => {
    ...
    const user_info = await getUserByClerkId(user.id);
